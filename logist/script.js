...
const revealGroups = [
  ...
  { selector: '.etrn__why-card', stagger: 0.08 },
  { selector: '.etrn__intro', stagger: 0 },
  { selector: '.etrn__step', stagger: 0.06 },
  { selector: '.etrn__title-card', stagger: 0.08 },
  { selector: '.etrn__rules-wrap', stagger: 0 },
  { selector: '.etrn__scenario', stagger: 0.08 },
  { selector: '.etrn__ready', stagger: 0 },
