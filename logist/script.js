...
const revealGroups = [
  ...
  { selector: '.etrn__timeline li', stagger: 0.06 },
  { selector: '.etrn__row', stagger: 0.05 },
  { selector: '.etrn__panel', stagger: 0.08 },
  { selector: '.etrn__scenarios-grid article', stagger: 0.08 },
